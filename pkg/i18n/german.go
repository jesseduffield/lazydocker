...
func germanSet() TranslationSet {
	return TranslationSet{
		...
		RemoveWithoutPrune: "entfernen, ohne die unmarkierten Elntern zu entfernen",
		...
		AnonymousReportingTitle:  "Mache dabei mit layzdocker besser zu machen",
		...
		ConfirmQuit:                "Bist dD dir sicher, dass du verlassen möchtest?", 
		...
		PressEnterToReturn:         "Drücke Eingabe um zu layzdocker zurück zu kehren. (Diese Nachfrage kann in Deiner Konfiguration deaktiviert werden, indem du folgenden Wert setzt: `gui.returnImmediately: true`)",
	}
}
