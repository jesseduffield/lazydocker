...
func frenchSet() TranslationSet {
	return TranslationSet{
		...
		RunningCustomCommandStatus: "exécution de la commande personnalisée",
		...
		WaitingForContainerInfo:    "Le processus ne peut pas continuer avant que docker fournisse plus d'informations. Veuillez réessayer dans quelques instants.",

		CannotAttachStoppedContainerError: "Vous ne pouvez pas vous attacher à un conteneur arrêté, vous devez le démarrer auparavant (ce que vous pouvez faire avec la touche 'r') (oui, je suis trop paresseux pour le faire automatiquement pour vous) (plutôt cool que je puisse communiquer en tête-à-tête avec vous au travers d'un message d'erreur, cependant)",
		CannotAccessDockerSocketError:     "Impossible d'accéder au socket docker à : unix:///var/run/docker.sock\nLancez lazydocker en tant que root ou lisez https://docs.docker.com/install/linux/linux-postinstall/",
		CannotKillChildError:              "Trois secondes se sont écoulées depuis que l'arrêt des processus enfants a été demandé. Il se peut qu'un processus orphelin continue à tourner sur votre système.",
		...
		NotEnoughSpace:             "Manque d'espace pour afficher les différents panneaux",
